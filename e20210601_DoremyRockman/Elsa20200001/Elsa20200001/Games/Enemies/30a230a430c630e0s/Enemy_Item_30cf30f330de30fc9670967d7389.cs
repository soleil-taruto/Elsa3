...
{
	public class Enemy_Item_ハンマー陰陽玉 : Enemy
	{
		public Enemy_Item_ハンマー陰陽玉(double x, double y)
			: base(x, y, 0, 0, false)
		{ }
		...
		protected override IEnumerable<bool> E_Draw()
		{
			for (; ; )
			{
				...
				{
					Game.I.Status.InventoryFlags[GameStatus.Inventory_e.取得済み_ハンマー陰陽玉] = true;
					break;
				}
