...
namespace Charlotte.Games.Enemies
{
	...
	public abstract class Enemy_HenyoriLaser : Enemy
	{
		...
		// ---- レーザー最小の当たり判定の直径 == 12.5 * 0.4 * 2 / 2 == 5.0
		// ---- 自機最小移動量 == 5.0 
		// <-- old

		// 上は間違い。
		// プレイヤーの当たり判定は現在の位置～前フレームの位置まで等間隔に５つプロットされる。
		// よって自機最小移動量を 1.0 と考えてよい。
		// よってレーザーの幅(Width)は 2.5 以上であること。
		// -- レーザー最小の当たり判定の直径 == 2.5 * 0.4 * 2 / 2 == 1.0
